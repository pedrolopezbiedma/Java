 ...
 *
 * @author PedroL
 * @Descripion: Class to handle the Monsters & Treasures lists 
 */
public class CardDealer {
    ...
    // ***** Class methods *****
    /*
    * Method that retrieves an instance of the class.
    ...
    */
    ...
    /*
    * Method that initializes the unused treasures deck.
    */
    ...
    /*
    * Method that initializes the unused monsters deck.
    */
    private void initMonsterCardDeck(){
        ...
        Monster monster = new Monster("3 Byakhees de bonanza", 1, badConsec, prize);
    ...
    /*
    * Method that shuffles the unused treasures deck.
    */
    ...
    /*
    * Method that shuffles the unused monsters deck.
    */
    ...
    /*
    * Method that retrieves the next treasure to be used from the unused treasures deck.
    * @return Next treasure to be used.
    */
    ...
    /*
    * Method that retrieves the next monster to be used from the unused monsters deck.
    * @return Next monster to be used.
    */
    ...
    /*
    * Method that moves a treasure to the used treasure list.
    * @param t Treasure to be moved to the used treasure list.
    */
    ...
    /*
    * Method that moves a monster to the used monster list.
    * @param m Monster to be moved to the used monsters list.
    */
    ...
    /*
    * Method that initializes the decks & shuffles the in order to start playing.
    */
