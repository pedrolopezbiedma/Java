...
public class Game {
    ...
    public static void main(String[] args) {
        ...
        do{
            ...
            switch(option){
            // ***** A�adir una opcion *****
            case 1: System.out.println( "Introduzca el valor de la fila a la que quiere a�adir un valor. [1-9]");
            		row = in.nextInt();
            		row = row-1;
            		System.out.println( "Introduzca el valor de la columna a la que quiere a�adir un valor. [1-9]");
            		col = in.nextInt();
            		col = col-1;
            		System.out.println( "Introduzca el valor que quiere a�adir.");
            		value = in.nextInt();
            		...
            		if(fits == true){
	            		...
	            		if(done == true){
	                		System.out.println( "Opcion a�adida correctamente.");            			
	            		} // if
	            		else{
	            			System.out.println( "La opcion no se ha podido a�adir.");            			
	            		} // else
            		} // if
            		else{
